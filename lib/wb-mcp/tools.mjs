...
export const WRITE_TOOL_SPECS = [
  ...
  },
  {
    ...
    summary: '写笔记（capsules 表，#标签 自动解析）',
    params: [
  ...
  },
  {
    ...
    summary: '全类型录入（AI 判类路由到 待办/闪念/bug/日程/成长等表）',
    params: [
      { name: 'text', type: 'string', required: true, positional: true, maxLen: 5000, longInput: true, desc: '录入原文（AI 自动判类；前缀「修复/优化/闪念/日程」可引导判类）' },
