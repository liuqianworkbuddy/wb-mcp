...
export const DOMAIN_TABLES = {
  ...
  闪念笔记: ['capsules', 'capsule_tags', 'capsule_categories', 'diaries', 'notes', 'tag_meta', 'thought_notes', 'obsidian_notes', 'knowledge_cards'],
...
export const SEARCH_CORE_TABLES = [
  'todos', 'capsules', 'diaries', 'notes', 'ai_ideas', 'ai_bugs', 'articles_inbox', 'people',
];
...
export const SEARCH_FIELDS = {
  ...
  diaries: ['title', 'plain_text', 'content_md'],
  notes: ['title', 'plain_text', 'content_md'],
  capsule_tags: ['name'],
